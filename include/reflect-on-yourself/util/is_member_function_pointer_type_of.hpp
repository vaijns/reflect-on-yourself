...
namespace roy::util{
	...
	struct is_member_function_pointer_type_of<TType (UDeclaringType::*)(VParamTypes...), UDeclaringType> : std::true_type{};

	template<typename T, typename UDeclaringType>
	inline constexpr bool is_member_function_pointer_type_of_v = is_member_function_pointer_type_of<T, UDeclaringType>::value;
