#ifndef H_REFLECT_ON_YOURSELF_UTIL_RETURN_TYPE_OF_FUNCTION_POINTER
#define H_REFLECT_ON_YOURSELF_UTIL_RETURN_TYPE_OF_FUNCTION_POINTER
...
namespace roy::util {
	...
	template<auto Ptr>
	using return_type_of_function_pointer_t = return_type_of_function_pointer<Ptr>::type;
} // namespace roy::util
#endif
