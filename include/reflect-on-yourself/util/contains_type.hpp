...
namespace roy::util {
	...
	struct contains_type<UWrapper<UCurrent, Vs...>, TContains> : contains_type<UWrapper<Vs...>, TContains> { };

	template<typename TContains, template<typename...> typename UWrapper, typename... Vs>
	struct contains_type<UWrapper<TContains, Vs...>, TContains> : std::true_type { };
