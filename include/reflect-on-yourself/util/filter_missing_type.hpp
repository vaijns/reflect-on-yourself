...
namespace roy::util{
	namespace detail{
		...
		template<
			typename TFilterType,
			typename... UFinishedTypes,
			template<typename...> typename VWrapper, typename... VRemainingTypes,
			missing_tag_type<TFilterType> WCurrentType
		> struct filter_missing_tag_type_impl<
			TFilterType,
			VWrapper<UFinishedTypes...>,
			VWrapper,
			WCurrentType,
			VRemainingTypes...
		> : filter_missing_tag_type_impl<
			TFilterType,
			VWrapper<UFinishedTypes...>,
			VWrapper,
			VRemainingTypes...
		...
		template<
			...
			typename... UFinishedTypes,
			template<typename...> typename VWrapper, typename... VRemainingTypes,
			tag_type<TFilterType> WCurrentType
		> struct filter_missing_tag_type_impl<
			TFilterType,
			VWrapper<UFinishedTypes...>,
			VWrapper,
		...
		> : filter_missing_tag_type_impl<
			TFilterType,
			VWrapper<UFinishedTypes..., WCurrentType>,
			VWrapper,
			VRemainingTypes...
		>{};
