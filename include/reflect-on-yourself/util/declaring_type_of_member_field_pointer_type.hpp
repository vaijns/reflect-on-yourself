#ifndef H_REFLECT_ON_YOURSELF_UTIL_DECLARING_TYPE_OF_MEMBER_FIELD_POINTER_TYPE
#define H_REFLECT_ON_YOURSELF_UTIL_DECLARING_TYPE_OF_MEMBER_FIELD_POINTER_TYPE
