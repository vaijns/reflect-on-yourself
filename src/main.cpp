...
namespace roy{
	template<> struct type_info_for<sub_type>
		: roy::type_info_provider<sub_type, roy::type_info<sub_type, "sub_type",
			roy::util::type_wrapper<
				roy::field<&sub_type::some_field, "some_field">
			>
		>
	>{};
